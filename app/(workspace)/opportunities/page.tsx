  ...
  return (
    <div className="mx-auto max-w-[1460px] px-4 py-7 sm:px-6 lg:px-8 lg:py-10">
      <div className="mb-8 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
        <div>
          <div className="flex items-center gap-3"><h1 className="text-[30px] font-semibold leading-tight tracking-[-0.045em] text-black sm:text-[36px]">SEO opportunities</h1><span className="rounded-full bg-[#dff5ff] px-3 py-1.5 text-[12px] font-bold text-black">{opportunities.length} open</span></div>
